...
import org.thinkingstudio.foxifiedlibrary.impl.event.EventFactoryImpl;
...
public final class EventFactory {
     ...
     * @return The Event instance.
     */
    public static <T> Event<T> createWithPhases(Class<? super T> type, Function<T[], T> invokerFactory, EventPhase... defaultPhases) {
