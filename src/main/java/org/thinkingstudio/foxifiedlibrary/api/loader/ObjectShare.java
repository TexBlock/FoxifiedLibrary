...
/**
 * Object share for inter-mod communication, obtainable through {@link FoxifiedLoader#getObjectShare}.
 *
...
public interface ObjectShare {
     ...
     * <pre>
     * if (FoxifiedLoader.getInstance().getObjectShare().get("someMod:someValue") instanceof String value) {
     *   // use value here
     * }
     * </pre>
     *
     ...
     * <pre>
     * if (FoxifiedLoader.getInstance().getObjectShare().get("mymod:fuel") instanceof Consumer{@code<?>} c) {
     ...
     * <p>Example use:
     * <pre>
     * FoxifiedLoader.getInstance().getObjectShare().whenAvailable("someMod:someValue", (k, v) -> {
