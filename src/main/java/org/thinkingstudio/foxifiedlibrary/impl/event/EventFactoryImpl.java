...
public final class EventFactoryImpl {
    ...
    public static void ensureContainsDefault(EventPhase[] defaultPhases) {
        for (EventPhase phase : defaultPhases) {
            if (phase.equals(EventPhase.DEFAULT)) {
                return;
            }
        }
    ...
    public static void ensureNoDuplicates(EventPhase[] defaultPhases) {
