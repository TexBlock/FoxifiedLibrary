package org.thinkingstudio.foxifiedlibrary.impl.event.toposort;
...
import org.thinkingstudio.foxifiedlibrary.FoxifiedLibraryMod;
        ...
        while (!pq.isEmpty()) {
            ...
            if (scc.nodes.size() > 1) {
                ...
                if (ENABLE_CYCLE_WARNING) {
                    ...
                    FoxifiedLibraryMod.LOGGER.warn(builder.toString());
                }
            }
